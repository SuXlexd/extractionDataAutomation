...
# LINK_WEB = 'https://www.mrcobra.mx/listado/accesorios-vehiculos/llantas/llantas-motos/_Desde_151_NoIndex_True'
...
for url_iterator in range(len(elements_url)):
    ...
    # Probar si hay un error de carga, recargar
    tester_iterator = 0
    if "Internal Server Error" in driver.title or tester_iterator == 10:
        sleep(random_time(TIME_RANGE_MD))
        driver.get(elements_url[url_iterator])
        tester_iterator += 1
        print('INTENTO : ' + str(tester_iterator) + " ELEMENTO : " + url_iterator + " LINK : " + elements_url[url_iterator])
    else:
        # Esperando elemento cargado para notificar de sitio listo
        ...
        while True:
            ...
            if check_exists_by_class(driver.find_element(By.XPATH, "/html/body"), 'nav-tools-footer') or i == 10:
                break
            else:
                i += 1
                print('PAGINA : ' + str(i))
